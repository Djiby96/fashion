...
if(countryCode){
    ...
    tn.textContent = `Hello, how are you? It appears to us that we see your exact location in the span class='text-uppercase'>${countryName}</span>, and `+ 
    ...
    tn.textContent = `Hello, how are you? Our geolocation system has noticed that our subsidiary store on Amazon is closer to you. If you wish to purchase this product, we will `+
    `do so from this store for a quick and cost-effective delivery. Thank you!`;
}
